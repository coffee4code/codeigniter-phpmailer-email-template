                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="padding-bottom: 30px;">
                          As a token of our appreciation, please accept this coupon code for <span style="font-weight:700; color: #E57373; font-size: 18px;">40% off</span> your next purchase!
                        </td>
                      </tr>
                      <tr>
                        <td class="code-block">
                      ...
                      <tr>
                        <td class="button">
                          ...
                          style="background-color:#E57373;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Shop Now</a></div>
                        </td>
                      </tr>
                    </table>
                  </td>
